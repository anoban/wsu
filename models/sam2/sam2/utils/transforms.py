...
class SAM2Transforms(nn.Module):
    def __init__(self, resolution, mask_threshold, max_hole_area: float = 0.0, max_sprinkle_area: float = 0.0):
        """
        Transforms for SAM2.
        """
        super().__init__()
    ...
    def transform_boxes(self, boxes: torch.Tensor, normalize: bool = False, orig_hw=None) -> torch.Tensor:
        """
