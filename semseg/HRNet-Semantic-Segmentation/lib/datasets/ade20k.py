...
class ADE20K(BaseDataset):
    def __init__(
        ...
        super(ADE20K, self).__init__(ignore_label, base_size, crop_size, downsample_rate, scale_factor, mean, std)
    ...
    def __getitem__(self, index):
        ...
        if "testval" in self.list_path:
            image = self.resize_short_length(image, short_length=self.base_size, fit_stride=8)
