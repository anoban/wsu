...
ROBOFLOW_CATEGORIES = {
    "sports": ["actions", "aerial-pool", "ball", "bibdetection", "football-player-detection", "lacrosse-object-detection"],
    "other": [
        "buoy-onboarding",
        "car-logo-detection",
...
def analyze_experiment_results(config_path: str) -> None:
    ...
    config_keys = ["lr_transformer", "lr_vision_backbone", "lr_language_backbone", "max_data_epochs"]
...
def main() -> None:
    ...
    parser.add_argument("-p", "--path", type=str, required=True, help="Root directory path containing experiment results")
