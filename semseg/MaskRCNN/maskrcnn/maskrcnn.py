# altered helper functions to create MaskRCNN class objects - altered from https://github.com/pytorch/vision/blob/main/torchvision/models/detection/mask_rcnn.py
...
from torchvision.models.detection.mask_rcnn import MaskRCNN, MaskRCNN_ResNet50_FPN_V2_Weights, MaskRCNN_ResNet50_FPN_Weights, MaskRCNNHeads
