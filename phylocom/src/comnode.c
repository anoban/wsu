                ...
                if ((t1.depth[xnode] == depth) && (active_n[xnode] == 1)) {
                    ...
                    if (t1.noat[xnode] == 0) {
                        ...
                        for (j = 0; j < t2.termtaxa; j++)
                            if (strcmp(t1.taxon[xnode], t2.taxalist[j]) == 0) common = 1;
                        if (common == 1) {
                        ...
                        for (j = 0; j < t1.noat[xnode]; j++) active_n[t1.down[xnode][j]] = 1;
                        active_n[xnode] = 0;
                    }
                }
            }
                ...
                if ((t2.depth[xnode] == depth) && (active_n[xnode] == 1)) {
                    ...
                    if (t2.noat[xnode] == 0) {
                        ...
                        for (j = 0; j < t1.termtaxa; j++)
                            if (strcmp(t2.taxon[xnode], t1.taxalist[j]) == 0) common = 1;
                        if (common == 1) {
                        ...
                        for (j = 0; j < t2.noat[xnode]; j++) active_n[t2.down[xnode][j]] = 1;
                        active_n[xnode] = 0;
                    }
                }
            }
        ...
        for (j = 0; j < t2.nnodes; j++) {
            ...
            for (p = 0; p < comlist1n[i]; p++) {
                for (q = 0; q < comlist2n[j]; q++) {
                    if (strcmp(t1.taxon[comlist1[i][p]], t2.taxon[comlist2[j][q]]) == 0) {
                        matched1[p] = 1;
                        matched2[q] = 1;
                    }
                }
            ...
            if ((matches1 == comlist1n[i]) && (matches2 == comlist2n[j]) && (matches1 > 1) && (matches2 > 1)) {
