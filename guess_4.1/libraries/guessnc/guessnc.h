 ...
 */
    ...
    bool get_attribute(int ncid_file, int ncid_var, const std::string& attr_name, std::string& value);
    ...
    bool get_attribute(int ncid_file, int ncid_var, const std::string& attr_name, double& value);
